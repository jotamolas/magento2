    ...
    return Component.extend({
        defaults: {
            ...
            selectedLocationTemplate:
                'Jotadevs_RedCustoms/store-selector/selected-location',
            storeSelectorPopupTemplate:
                'Jotadevs_RedCustoms/store-selector/popup',
        ...
        initialize: function () {
            ...
            updateNearbyLocations = _.debounce(function () {
         ...
         * @returns {*}
         */
        updateNearbyLocations: function () {
            var self = this,
                productsInfo = [],
